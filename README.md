...
- [**cellular_automata**](https://cellular.valflrt.dev) – a tiny website to fiddle with fun cellular automata
- [**http_server**](https://gitlab.com/valflrt/http_server) – a basic http server written in rust using tcp utilities from the standard library
